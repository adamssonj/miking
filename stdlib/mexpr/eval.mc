...
lang SeqOpEval = SeqOpAst + IntAst + BoolAst + ConstEval + SeqOpArity + VarAst
   sem delta info =
...
lang SeqOpEvalApply = SeqOpAst + IntAst + BoolAst + ConstEval + SeqOpArity
  sem delta info =
  | (CMap _, [f, TmSeq s]) ->
...
lang MExprEval =
  ...
  SymbEval + CmpSymbEval + SeqOpEval + SeqOpEvalApply + FileOpEval + IOEval + SysEval +
